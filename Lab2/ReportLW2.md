...
2. **Цель работы**: ознакомиться с терминалом Linux
3. **Задание**:
...
4. **Идея, метод, алгоритм решения задачи**: методом поиска нужной информации (методом научного тыка).
...
tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ touch file.txt

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ touch jfile.txt
...
tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ mv LislingLW2.md ReportLW2.md

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ ls
readme.md  ReportLW2.md

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ tar -cvf a.tar ReportLW2.md
ReportLW2.md

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ ls
a.tar  readme.md  ReportLW2.md

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ scp a.tar e_fedorova@185.5.249.140:
a.tar                               100%   50KB   1.3MB/s   00:00    
...
Last login: Sun Oct  1 23:00:24 2023 from 85.143.224.37

e_fedorova@vds2476450:~$ ls
A  archive.tar  a.tar

e_fedorova@vds2476450:~$ tar -xvf a.tar
ReportLW2.md

e_fedorova@vds2476450:~$ ls
A  archive.tar  a.tar  ReportLW2.md
...
tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ scp e_fedorova@185.5.249.140:~/ReportLW2.md /home/tsar_belyash/'Рабочий стол'/ForLabs/Lab2
ReportLW2.md                           100%   46KB 460.1KB/s   00:00    
...
tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git add ReportLW2.md

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git add a.tar

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git rm ListingLW2.md
rm 'Lab2/ListingLW2.md'
...
Изменения, которые будут включены в коммит:
  (используйте «git restore --staged <файл>...», чтобы убрать из индекса)
	удалено:       ListingLW2.md
	новый файл:    ReportLW2.md
	новый файл:    a.tar

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git commit
[master 715c540] AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
 3 files changed, 1068 insertions(+)
 delete mode 100644 Lab2/ListingLW2.md
 create mode 100644 Lab2/ReportLW2.md
 create mode 100644 Lab2/a.tar
tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git status
Текущая ветка: master
...
Запись объектов: 100% (12/12), 12.67 КиБ | 1.15 МиБ/с, готово.
Всего 12 (изменений 2), повторно использовано 0 (изменений 0), повторно использовано пакетов 0
remote: Resolving deltas: 100% (2/2), done.
To github.com:Ekaterina108B/ForLabs.git
   2d8b4ca..715c540  master -> master
...
tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git branch labaaaaaaa2

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git checkout labaaaaaaa2
Переключились на ветку «labaaaaaaa2»

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ cat > ReportLW2.md
It is a new report-file, because I should be do it before work, not after

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git status
Текущая ветка: labaaaaaaa2
Изменения, которые не в индексе для коммита:
  (используйте «git add <файл>...», чтобы добавить файл в индекс)
  (используйте «git restore <файл>...», чтобы отменить изменения в рабочем каталоге)
	изменено:      ReportLW2.md
индекс пуст (используйте «git add» и/или «git commit -a»)

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git add ReportLW2.md

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git commit
[labaaaaaaa2 a0f235c] A few changes in file
 1 file changed, 1 insertion(+), 1068 deletions(-)
 rewrite Lab2/ReportLW2.md (100%)

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git push origin labaaaaaaa2
...
remote: 
remote: Create a pull request for 'labaaaaaaa2' on GitHub by visiting:
remote:      https://github.com/Ekaterina108B/ForLabs/pull/new/labaaaaaaa2
remote: 
To github.com:Ekaterina108B/ForLabs.git
 * [new branch]      labaaaaaaa2 -> labaaaaaaa2
tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git status
Текущая ветка: labaaaaaaa2
нечего коммитить, нет изменений в рабочем каталоге

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git checkout master
...
tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git merge labaaaaaaa2
Обновление 715c540..a0f235c
Fast-forward
 Lab2/ReportLW2.md | 1069 +------------------------------------
 1 file changed, 1 insertion(+), 1068 deletions(-)
tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git branch -d labaaaaaaa2
Ветка labaaaaaaa2 удалена (была a0f235c).
...
tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git push origin --all
Всего 0 (изменений 0), повторно использовано 0 (изменений 0), повторно использовано пакетов 0
To github.com:Ekaterina108B/ForLabs.git
   715c540..a0f235c  master -> master

tsar_belyash@Tsar--Belyash:~/Рабочий стол/ForLabs/Lab2$ git push origin -d labaaaaaaa2
To github.com:Ekaterina108B/ForLabs.git
 - [deleted]         labaaaaaaa2

  ```
7. **Замечания автора** по существу работы: -.
8. **Выводы**: в ходе выполнения данной лабораторной работы я ознакомилась с терминалом Linux: полученные знания помогут мне в дальнейшем прохождении курса. Я научилась подключаться к удалённой машине, а также не глубоко изучила (опробовала) команды, данные в задании.
